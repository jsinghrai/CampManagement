...
$phone=$_POST['phone'];
$assohospital=$_POST['assohospital'];
...
if(mysqli_num_rows($res)>0)
...
else
  {
   // $sql="insert into users(username,email,password,dept) values('".$username."','".$email."','".$password."','".$dept."')";
    ...
    $sql = "insert into users(uid,username,email,phone,password,assohospital) values('".$uid."','".$username."','".$email."','".$phone."','".$password."','".$assohospital."')";
