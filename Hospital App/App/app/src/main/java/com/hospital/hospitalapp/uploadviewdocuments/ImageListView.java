...
public class ImageListView extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    public static final String GET_IMAGE_URL="http://10.34.31.61/hospital/getAllImages.php";
    ...
    private void getImages(){
        class GetImages extends AsyncTask<Void,Void,Void> {
            ...
            protected void onPostExecute(Void v) {
                ...
                Log.d("tag","url-->"+GetAlImages.imageURLs.toString());
            }
            ...
            protected String doInBackground(String... strings) {
                ...
                try {
                    ...
                    while((json = bufferedReader.readLine())!= null){
                        ...
                        sb.append(json+"\n");
                        Log.d("tag","urlstring-->"+sb.toString());
                    }
