...
public class MyCalendarActivity extends Activity implements OnClickListener {
    ...
    String clickdate;
    String appointment_url = "http://10.34.31.61/hospital/bookappointment.php";
    String checkdates_url = "http://10.34.31.61/hospital/checkavailabilty.php";
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		Log.d("tag", "datacalendar--" + patient_name +patient_email +doctor_email +doctor_name);
    ...
    public class GridCellAdapter extends BaseAdapter implements OnClickListener {
        ...
        public void onClick(View view) {
            ...
            RequestQueue requestQueue = Volley.newRequestQueue(MyCalendarActivity.this);
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, checkdates_url,
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String ServerResponse) {
                            ...
                            Log.d("tag", "responsedate--" + ServerResponse);
                            if (ServerResponse.equalsIgnoreCase("Booked")) {
                                android.support.v7.app.AlertDialog.Builder builder1 = new android.support.v7.app.AlertDialog.Builder(MyCalendarActivity.this);
                                builder1.setMessage("Not Available");
                    ...
                    new Response.ErrorListener() {
                        ...
                        public void onErrorResponse(VolleyError volleyError) {
                            ...
                            Toast.makeText(MyCalendarActivity.this, volleyError.toString(), Toast.LENGTH_LONG).show();
                        }
                    }) {
                @Override
        ...
        public void bookDate() {
            android.support.v7.app.AlertDialog.Builder builder1 = new android.support.v7.app.AlertDialog.Builder(MyCalendarActivity.this);
            builder1.setMessage("Are you sure,you want to book?");
            builder1.setCancelable(false);
            builder1.setNegativeButton(
                    "No",
                    new DialogInterface.OnClickListener() {
            ...
            builder1.setPositiveButton(
                    ...
                    new DialogInterface.OnClickListener() {
                        public void onClick(final DialogInterface dialog, int id) {
                            RequestQueue requestQueue = Volley.newRequestQueue(MyCalendarActivity.this);
                            final ProgressDialog progressDialog = new ProgressDialog(MyCalendarActivity.this);
                            progressDialog.setMessage("Registering...");
                            StringRequest stringRequest = new StringRequest(Request.Method.POST, appointment_url,
